...
/**
 * Criteria class for the {@link fr.tycabris.domain.Poids} entity. This class is used
 * in {@link fr.tycabris.web.rest.PoidsResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /poids?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class PoidsCriteria implements Serializable, Criteria {
    ...
    public PoidsCriteria(){
    }

    public PoidsCriteria(PoidsCriteria other){
    ...
    @Override
    public PoidsCriteria copy() {
        return new PoidsCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final PoidsCriteria that = (PoidsCriteria) o;
        return
